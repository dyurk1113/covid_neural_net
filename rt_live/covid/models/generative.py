...
import os
os.environ['THEANO_FLAGS'] = 'device=cuda,floatX=float32,force_device=True,gpuarray.preallocate=1'

import theano
import theano.tensor as tt
from theano.tensor.signal.conv import conv2d

from rt_live.covid.patients import get_delay_distribution
...
class GenerativeModel:
    ...
    def build(self):
        ...
        with pm.Model(coords=coords) as self.model:
            ...
            nonzero_observed_positive = pm.Data("nonzero_observed_positive",
